...
public final class AES_V1 implements IAES
{
    ...
    public AES_V1(String i_PrivateKey)
    {
    ...
    public AES_V1(String i_PrivateKey ,int i_PasswordSize)
    {
        try
        {
            // 1.构造密钥生成器，指定为AES算法,不区分大小写
            KeyGenerator keygen = KeyGenerator.getInstance($AES_Name);
            ...
            // 5.根据字节数组生成AES密钥
            this.key = new SecretKeySpec(raw ,$AES_Name);
        }
        catch(Exception e)
        {
