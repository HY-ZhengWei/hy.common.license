...
import org.hy.common.license.StrConv;
...
public class JU_Base64
{
    ...
    private static final byte [] $Lsi = {1 ,1 ,2 ,2 ,2 ,2 ,2 ,2 ,1 ,2
                                        ,2 ,2 ,2 ,2 ,2 ,1 };
    ...
    public void test()
    {
        ...
        String    v_Key          = "795597";
        String    v_PwdB64       = StrConv.sFromBase64(v_Password);
        String [] v_PwdB64Arr    = v_PwdB64.split(","); 
        String    v_DecodeB64    = "";
        byte   [] v_KeyBytes     = ByteHelp.toByte(v_Key);
        ...
        for (int i=0; i<v_PwdB64Arr.length; i++)
        {
            v_DecodeB64 += (char)Integer.parseInt(v_PwdB64Arr[i]);
        }
        
        System.out.println(v_DecodeB64);
        System.out.println(StrConv.convCp1251ToUnicode(v_DecodeB64));
