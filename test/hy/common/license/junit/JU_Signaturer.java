...
public class JU_Signaturer
{
    ...
    public void test_V1() throws UnsupportedEncodingException
    {
        ...
        System.out.println(v_Signaturer.sign("appKey" + "0904202FB2EA4AC3A899B423928A0F8E" + "timestamp" + "1609145532201"));
        System.out.println(URLEncoder.encode(v_Signaturer.sign("appKey" + "0904202FB2EA4AC3A899B423928A0F8E" + "timestamp" + "1609145532201") ,"UTF-8"));
    }
